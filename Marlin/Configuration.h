...
#define STRING_CONFIG_H_AUTHOR "(Ghost, Anet A8 dual extruder on skr 1.4 v.20007(bugfix), on the 11.10.2020)" // Who made the changes.
...
#define HOTEND_OFFSET_X { 0.0, 35.90 } // (mm) relative X-offset for each nozzle
...
#define TEMP_BED_WINDOW          13 // (°C) Temperature proximity for the "temperature reached" timer
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 396.04, 396.04, 1624.36, 389.68 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 600, 600, 7.5, 75 }
//#define manual_feedrate_mm_s.x= { 600, 600, 7.5, 75 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 350, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 18, -21, 0 }
